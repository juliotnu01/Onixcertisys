        ...
        @endforeach
         <tr>
            <td style="text-align: right;" colspan="11">
                <h3><strong>Sub Total:</strong> {{$data['has_cotizaicon']['has_moneda']['clave']}} {{number_format($data['has_cotizaicon']['sub_total'], 2, ',', '.')}}</h3>
                <h3><strong>I.V.A:</strong> {{$data['has_cotizaicon']['has_moneda']['clave']}} {{number_format($data['has_cotizaicon']['iva'], 2, ',', '.')}}</h3>
                <h3><strong>Total:</strong> {{$data['has_cotizaicon']['has_moneda']['clave']}} {{number_format($data['has_cotizaicon']['total'], 2, ',', '.')}}</h3>
            </td>
        </tr>
    </table>
</body>
