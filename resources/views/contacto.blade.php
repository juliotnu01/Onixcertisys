...
<body>
    ...
    <section class="jumbotron">
        <div class="img-bg img-mty" style="background-image: url(assets/img/mty-fondo.jpeg)">
            <div class="container-fluid cont-mty">
                <div class="logo">
                    ...
                    <div class="contacto-fondo">
                        ...
                        <div class="items">
                            ...
                            <div class="contacto-item">
                                ...
                                <p>Calle 24 #600, Residencial Las Puentes<br>3er Sector, San Nicolás de los Garza, N.L.<br>México</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="container-fluid">
        <div class="row">
            ...
            <form class="formulario col-9" action="mailto:contacto@accredian.org" method="POST" enctype="text/plain" id="form-correo">
