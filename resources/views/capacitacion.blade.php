...
<body>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="#">Venta Equipos </a></li>
    ...
    <section id="sectionCatalogosDeCursos">
        <div class="row">
            <div class="col col-3">
            <img src="assets/img/magnitudes.png" alt="Magnitudes" width="70%" height="50%">
            </div>
            <div class="col col-9">
                <table id="tablaCursos" >
                    <thead>
                        <th>
                            <tr>
                                <td colspan="2" id="titulosTablaCursos" style="letter-spacing: 3px; font-size: 30px;" >CATÁLOGO DE CURSOS</td>
                            </tr>
                            <tr>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2" id="titulosTablaCursos" >METROLOGÍA</td>
                        </tr>
                        <tr>
                            <td>Basico de Metrología</td>
                            <td>1 dia</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" id="titulosTablaCursos">LABORATORIOS ISO/IEC-17025</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" id="titulosTablaCursos" >AUTOMOTRIZ IATF-16949</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" id="titulosTablaCursos" >CALIDAD ISO-9001</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" id="titulosTablaCursos" >AMBIENTAL ISO-14001</td>
                        </tr>
                        <tr>
