                            ...
                            <v-col cols="12" xs="12" sm="12" md="12" lg="12">
                                <v-row>
                                    <v-col cols="12" xs="12" sm="12" md="6" lg="6">
                                        <v-autocomplete v-model="magnitudSelected" :items="magnitudes" outlined dense item-text="nombre" return-object label="Seleccionar magnitud"></v-autocomplete>
                                    </v-col>
                                    <v-col cols="12" xs="12" sm="12" md="2" lg="2">
                                        <v-btn text color="primary" @click="imprimirReciboUser(selected, magnitudSelected)">
