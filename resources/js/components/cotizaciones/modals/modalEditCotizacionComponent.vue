        ...
        <v-card-text>
          <v-form ref="f_mag">
            <v-row
              ...
              v-if="Object.entries(this.cotizacion).length > 0"
            >
              <v-col cols="12" xs="12" sm="12" md="2" lg="2">
                <v-autocomplete
                  offset-y
                  dense
                  v-model="cotizacion.has_cliente"
                  :items="clientes"
              ...
              <v-col cols="12" xs="12" sm="12" md="2" lg="2">
                <v-autocomplete
                  offset-y
                  dense
                  v-model="cotizacion.sucursal_cliente_id"
                  :items="cotizacion.has_cliente.has_sucursal"
              ...
              <v-col cols="12" xs="12" sm="12" md="3" lg="2">
                <v-autocomplete
                  offset-y
                  dense
                  v-model="cotizacion.has_tiempo_de_entrega"
              ...
              <v-col cols="12" xs="12" sm="12" md="3" lg="2">
                <v-autocomplete
                  offset-y
                  dense
                  v-model="cotizacion.has_empleado"
                  :items="empleados"
              ...
              <v-col cols="12" xs="12" sm="12" md="6" lg="6">
                <v-select
                  offset-y
                  dense
                  v-model="cotizacion.tipo_de_servicio"
              ...
              <v-col cols="12" xs="12" sm="12" md="6" lg="6">
                <v-select
                  offset-y
                  dense
                  v-model="cotizacion.estado_de_la_cotizacion"
              ...
              <v-col cols="12" xs="12" sm="12" md="6" lg="6">
                <v-textarea
                  v-model="cotizacion.nota_para_la_cotizacion"
                  outlined
