<template>
    <v-app>
        <v-dialog v-model="openDialog" width="900" persistent fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-card>
                ...
                <v-card-text>
                    <v-form ref="f_mag">
                        <v-row align="center" justify="space-around">
                            ...
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                                <v-text-field :rules="[rules.required]" v-model="model.contacto" dense outlined label="Contacto" />
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                                <v-text-field :rules="[rules.required]" v-model="model.telefono" dense outlined label="Teléfono" />
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                                <v-text-field :rules="[rules.required]" v-model="model.correo" dense outlined label="Correo" />
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                ...
                <v-card-actions>
                    <v-btn text color="blue" @click.prevent="addCotizacion">
                        Agregar
                    </v-btn>
    ...
    data() {
        return {
            ...
            tipo_de_servicio: [
                ...
                { name: 'programado', value: 3 },
            ],
            estado_de_la_cotizacion: [
                { name: 'pendiente', value: 1 },
                { name: 'En recibo', value: 2 },
            ...
            headers_cotizacion: [
                { text: 'Identicacion', value: 'identificacion' },
                { text: 'Servicio', value: 'servicio.name' },
                { text: 'Unidad', value: 'unidad.name' },
                { text: 'Cantidad', value: 'cantidad' },
                { text: 'Instrumento', value: 'instrumento.nombre' },
