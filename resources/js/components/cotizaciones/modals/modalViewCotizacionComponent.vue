                ...
                <v-card-text>
                    <v-container>
                        <v-row align="center" justify="space-around" v-if=" Object.entries(this.cotizacion_view).length > 0 ">
                            ...
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                                <v-autocomplete disabled offset-y dense v-model="cotizacion_view.has_moneda" :items="monedas" item-text="clave" outlined label="Seleccionar Moneda" return-object></v-autocomplete>
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                                <v-autocomplete disabled offset-y dense v-model="cotizacion_view.has_tiempo_de_entrega" :items="tiempos_de_entrega" item-text="nombre" outlined label="Tiempo de Entrega" return-object></v-autocomplete>
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                            ...
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                                <v-text-field disabled :rules="[rules.required]" v-model="cotizacion_view.has_cliente.celular_contacto" dense outlined label="Teléfono" />
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                                <v-text-field disabled :rules="[rules.required]" v-model="cotizacion_view.has_cliente.correo_contacto" dense outlined label="Correo" />
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                                <v-text-field disabled :rules="[rules.required]" v-model="cotizacion_view.condicion" dense outlined label="Condiciones" />
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="6" lg="6">
                                <v-textarea disabled v-model="cotizacion_view.nota_para_la_cotizacion" outlined label="Notas de la cotizacion"></v-textarea>
                            </v-col>
                            <v-col cols="12" xs="12" sm="12" md="6" lg="6">
                                <v-textarea disabled v-model="cotizacion_view.nota_de_seguimiento" outlined label="Notas de seguimiento"></v-textarea>
                            </v-col>
                        </v-row>
                    </v-container>
