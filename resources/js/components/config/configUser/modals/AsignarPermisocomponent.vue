        ...
        <v-dialog v-model="openPermisoRolDialog" width="700">
            <v-card>
                ...
                <v-container>
                    ...
                    <v-card-actions>
                        <v-btn text color="blue" @click="AsignarPermiso">
                            Guardar Permisos
                        </v-btn>
                        <v-btn text color="red" @click="openPermisoRolDialog = false">
                            Cerrar
                        </v-btn>
                    </v-card-actions>
                </v-container>
...
export default {
    ...
    methods: {
        async AsignarPermiso() {
            var model = {
                crear: this.user_selected_rol_premision.user_has_rol.associated_rol_premission.crear,
                leer: this.user_selected_rol_premision.user_has_rol.associated_rol_premission.leer,
                actualizar: this.user_selected_rol_premision.user_has_rol.associated_rol_premission.actualizar,
                eliminar: this.user_selected_rol_premision.user_has_rol.associated_rol_premission.eliminar,
