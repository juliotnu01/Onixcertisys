    ...
    data() {
        return {
            headers_empleado: [
                ...
                { text: 'Fecha de alta', align: 'center', sortable: false, value: 'fecha_de_alta' },
                { text: 'Fecha de baja ', align: 'center', sortable: false, value: 'fecha_de_baja' },
                { text: 'Status', align: 'center', sortable: false, value: 'status' },
                { text: 'Nombre Completo', align: 'center', sortable: false, value: 'nombre_completo' },
                { text: 'R.F.C', align: 'center', sortable: false, value: 'rfc' },
                { text: 'Dirección', align: 'center', sortable: false, value: 'direccion' },
                { text: 'Ciudad', align: 'center', sortable: false, value: 'ciudad' },
                { text: 'Departamento', align: 'center', sortable: false, value: 'departamento' },
                ...
                { text: 'Correo Factura', align: 'center', sortable: false, value: 'correo_factura' },
                { text: 'Observaciones', align: 'center', sortable: false, value: 'observaciones' },
