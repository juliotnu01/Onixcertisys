    ...
    <v-card class="p-2">
      ...
      <v-toolbar flat color="white">
        ...
        <v-btn
          ...
          dark
          color="primary"
          @click="$store.commit('setDialogAddEmpleado', true)"
        >
...
export default {
  ...
  methods: {
    ...
    async cargarDocumentoEmpleado() {
      try {
        this.loadingUpload = true;
        await this.services.empleadoServices.agregarEmpleadoMasivamente(this.files[0]);
