    ...
    data() {
        return {
            headers_empleado: [
                ...
                { text: 'Fecha de Calibracion', align: 'center', sortable: false, value: 'fecha_calibracion' },
                { text: 'Fecha de Vencimiento ', align: 'center', sortable: false, value: 'fecha_vencimiento' },
