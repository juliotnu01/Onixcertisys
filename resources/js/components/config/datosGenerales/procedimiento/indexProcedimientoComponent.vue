...
export default {
    ...
    data() {
        return {
            headers_tde: [
                { text: 'ID', align: 'start', sortable: false, sortable: true, value: 'id' },
                { text: 'Nombre de Moneda', align: 'start', sortable: false, value: 'nombre' },
                { text: 'Agregado', align: 'end', sortable: false, value: 'created_at' },
