...
export default {
    ...
    computed: {
        ...
        openDialog: {
            get() {
                return this.dialog_edit_instrumento
            },
            set(val) {
                this.$store.commit('setDialogEditInstrumento', val)
            }
        }
    ...
    mounted() {},
    methods: {
        async EditIntrumento() {
            if (this.$refs.f_mag.validate()) {
                await this.services.instrumentoServices.actualizarInstrumento(this.instrumento)
