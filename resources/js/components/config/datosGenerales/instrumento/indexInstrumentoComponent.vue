    ...
    <v-card class="p-2">
      ...
      <v-toolbar flat color="white">
        ...
        <v-btn
          ...
          dark
          color="primary"
          @click="cargarDocumentoInstrumento"
          class="mb-10"
        ...
        <v-btn
          ...
          dark
          color="primary"
          @click="$store.commit('setDialogAddInstrumento', true)"
          class="mb-10"
        >
...
import notificacionesComponent from '../../../notificacion/indexComponentNotificacion.vue'
export default {
  components: {
    "modal-add": modalAddIntrumento,
    "modal-edit": modalEditIntrumento,
    "notificacion": notificacionesComponent,
  },
  data() {
    return {
      headers_rol: [
        ...
        },
        {
          ...
          align: "center",
          sortable: false,
          value: "has_acreditacion.nombre",
        },
        {
          text: "Area",
          align: "center",
          sortable: false,
          value: "has_magnitud.nombre",
        },
        {
          text: "Precio Venta",
          align: "center",
  ...
  methods: {
    ...
    async cargarDocumentoInstrumento(){
        try {
              this.loadingUpload = true
              await this.services.instrumentoServices.AgregarInstrumentoMasivamente(this.files[0]);
