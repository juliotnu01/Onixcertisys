      ...
      <v-container>
        <v-toolbar flat color="white">
          ...
          <v-btn
            ...
            dark
            color="primary"
            @click="$store.commit('setDialogAddMoneda', true)"
          >
...
export default {
  ...
  methods: {
    ...
    async cargarDocumentoMoneda() {
      try {
        this.loadingUpload = true;
        await this.services.monedaServices.agregarMonedaMasivamente(this.files[0]);
