            ...
            >
              <v-col cols="12" xs="12" sm="12" md="2" lg="2">
                <v-autocomplete
                  offset-y
                  dense
                  v-model="cotizacion_para_duplicar.has_cliente"
                  :items="clientes"
              ...
              <v-col cols="12" xs="12" sm="12" md="3" lg="2">
                <v-autocomplete
                  offset-y
                  dense
                  v-model="cotizacion_para_duplicar.has_moneda"
                  :items="monedas"
                  item-text="clave"
                  outlined
                  s
              ...
              <v-col cols="12" xs="12" sm="12" md="3" lg="2">
                <v-autocomplete
                  offset-y
                  dense
                  v-model="cotizacion_para_duplicar.has_tiempo_de_entrega"
              ...
              <v-col cols="12" xs="12" sm="12" md="3" lg="2">
                <v-autocomplete
                  offset-y
                  dense
                  v-model="cotizacion_para_duplicar.has_empleado"
                  :items="empleados"
              ...
              <v-col cols="12" xs="12" sm="12" md="6" lg="6">
                <v-select
                  offset-y
                  dense
                  v-model="cotizacion_para_duplicar.tipo_de_servicio"
              ...
              <v-col cols="12" xs="12" sm="12" md="6" lg="6">
                <v-select
                  offset-y
                  dense
                  v-model="cotizacion_para_duplicar.estado_de_la_cotizacion"
  ...
  methods: {
    ...
    async AddCotizacion() {
      if (this.$refs.f_mag.validate()) {
        await this.services.cotizacionServices.agregarCotizacionDuplicada(
