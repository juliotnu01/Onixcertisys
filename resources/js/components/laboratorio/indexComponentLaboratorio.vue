...
export default {
    ...
    return {
      ...
      headers: [
        ...
        },
        {
          ...
          sortable: true,
          value:
            "has_recibo.has_cotizaicon.has_cliente.datos_fisicos_requeremientos_facturacion_razon_social",
        },
        {
          text: "Magnitud",
          align: "center",
  ...
  async mounted() {
    ...
    Promise.all([this.services.partidaServices.getlistpartidasParaCalibrar()])
      .then(() => {
